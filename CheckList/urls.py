...
from .views import single_checlist_item_status_view, checklist_item_list_view, create_checklist_item_status_list , checklist_item_list_view_self , update_checklist_item
...
urlpatterns = [
    ...
    path('checklist/update/statusitemlist/<str:pk>', update_checklist_item, name='update_checklist_item'),
]